ui.videos = (function () {
    ...
    generateHTML.video = function (obj) {
        ...
        return "<article class=\"box card\" dir=ltr>" +
            "    <div class=video>" +
                (ui.video.youtubeSupport ? "<iframe src=\"https://www.youtube.com/embed/" + obj.id + "?autoplay=1\" allow=\"autoplay; encrypted-media; picture-in-picture; fullscreen\"></iframe>" : ui.video.template(obj.id)) +
            "    </div>" +
